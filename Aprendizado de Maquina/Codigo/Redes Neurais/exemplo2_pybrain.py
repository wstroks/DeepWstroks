# -*- coding: utf-8 -*-
"""
Created on Tue May 29 23:34:29 2018
...
rede = buildNetwork(2,3,1,outclass=SoftmaxLayer,
                    hiddenclass=SigmoidLayer,bias=False)#dois neuronios na camada de entrada,3 oculta e 1 saida
print(rede['in'])
print(rede['hidden0'])
print(rede['out'])
print(rede['bias'])'''
rede = buildNetwork(2,3,1)
base = SupervisedDataSet(2,1)#dois atributos previsores e uma classe
#operadorXor
